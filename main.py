...
print("-----------------")
print()
J1614 = pd.read_csv("J1614-2230.residuals.csv")
J1614s = pd.read_csv("J1614-2230.residuals.SIMPLIFIED.csv")
print(J1614.head())
print()
...
print("-----------------")
print()
J2222 = pd.read_csv("J2222-0137.residuals.csv")
J2222s = pd.read_csv("J2222-0137.residuals.SIMPLIFIED.csv")
print(J2222.head())
print()
